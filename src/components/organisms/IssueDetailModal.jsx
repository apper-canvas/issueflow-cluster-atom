  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
            ...
            {/* Header */}
            <div
                className="px-6 py-4 border-b border-secondary-200 bg-gradient-to-r from-primary-50 to-accent-50">
            ...
            {/* Content */}
            <div
                className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-200px)] scrollbar-thin">
                {/* Description */}
                <div>
                ...
                <div className="grid grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <div
                                className="w-8 h-8 bg-accent-100 rounded-full flex items-center justify-center">
                    ...
                    <div>
                        ...
                        {issue.dueDate ? <div>
                            ...
                            {isPast(new Date(issue.dueDate)) && issue.status !== "resolved" && issue.status !== "closed" && <div className="flex items-center gap-1.5 mt-2 text-red-600">
                                <ApperIcon name="AlertCircle" size={14} />
                                <span className="text-xs font-semibold uppercase">Overdue</span>
                            </div>}
                        </div> : <div className="flex items-center gap-2 text-secondary-400">
            ...
            {/* Comments Section */}
            <div className="border-t border-secondary-200 bg-secondary-50 p-6">
                <div className="flex items-center gap-2 mb-4">
                    <ApperIcon name="MessageSquare" size={20} className="text-secondary-700" />
                    <h3 className="text-lg font-semibold text-secondary-900">Discussion</h3>
                </div>
    ...
    {/* Footer */}
    <div
        className="flex items-center justify-between px-6 py-4 border-t border-secondary-200 bg-secondary-50">
        <Button
            variant="danger"
            size="md"
            onClick={() => {
